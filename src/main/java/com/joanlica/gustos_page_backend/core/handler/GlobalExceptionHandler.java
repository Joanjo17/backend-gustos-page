...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleClientNotFoundException(UsuarioNotFoundException ex, HttpServletRequest req) {
        return errorFactory.entity(HttpStatus.NOT_FOUND, "usuario-not-found",
                ex.getMessage(), req.getRequestURI(), Map.of());
    }

    @ExceptionHandler(RoleNotFoundException.class)
    public ResponseEntity<Object> handleRoleNotFoundException(RoleNotFoundException ex, HttpServletRequest req) {
        return errorFactory.entity(HttpStatus.NOT_FOUND,"role-not-found",
                ex.getMessage(), req.getRequestURI(), Map.of());
    }

    @ExceptionHandler(LikeNotFoundException.class)
    public ResponseEntity<Object> handleLikeNotFoundException(LikeNotFoundException ex, HttpServletRequest req) {
        return errorFactory.entity(HttpStatus.NOT_FOUND,"like-not-found",
                ex.getMessage(), req.getRequestURI(), Map.of());
    }
